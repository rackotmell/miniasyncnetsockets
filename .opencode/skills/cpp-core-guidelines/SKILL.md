...
description: C++ coding standards based on the C++ Core Guidelines. Use when writing, reviewing, or refactoring C++ code to enforce modern, safe, and idiomatic practices.
origin: ECC
---
